...
import (
	...
	"github.com/helber/etcdtool/command"
...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		cli.StringFlag{Name: "user, u", Value: "", EnvVar: "ETCDTOOL_USER", Usage: "User"},
		cli.StringFlag{Name: "password, w", Value: "", EnvVar: "ETCDTOOL_PASSWORD", Usage: "Password"},
